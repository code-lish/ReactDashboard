...
import { selectUserById, useUpdateUserMutation } from "../../features/users/userApiSlice";
...
const EditUser = () => {
    ...
    const onSubmitHandler = async (data) => {
        ...
        try {
            data.image = attachmentsFile === undefined ? user?.image : attachmentsFile
            ...
            await editUser({ id, formData }).unwrap();
            await MySwal.fire({
                title: t("success"),
